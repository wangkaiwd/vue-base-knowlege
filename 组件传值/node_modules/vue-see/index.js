...
seePlugin.install = function(Vue, userOptions) {
    ...
    Vue.component('see-item', {
        ...
        template: '<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><a :href="url" itemprop="contentUrl" :data-size="size"><img :src="url" itemprop="thumbnail" :alt="caption" /></a><figcaption itemprop="caption description">{{caption}}</figcaption></figure>',
        computed: {
            size: function() {
